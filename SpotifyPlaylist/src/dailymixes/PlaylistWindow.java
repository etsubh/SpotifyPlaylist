...
/**
 * The play list GUI window that displays the songs in the queue and the songs
 * in the play list. The user can accept or reject (>:(<) a song.
 *
 * @author CS 2114
 * @version Spring 2024
 */
public class PlaylistWindow
{
    ...
    public PlaylistWindow(PlaylistCalculator playlistCalculator)
    {
        ...
        PLAYLIST_COLORS[0] = new Color(51, 92, 103);
        PLAYLIST_COLORS[1] = new Color(224, 159, 62);
        PLAYLIST_COLORS[2] = new Color(158, 42, 43);
        PLAYLIST_COLORS[3] = new Color(17, 17, 17);
        PLAYLIST_COLORS[4] = new Color(38, 68, 77);
        PLAYLIST_COLORS[5] = new Color(97, 69, 27);
        PLAYLIST_COLORS[6] = new Color(71, 19, 19);
        PLAYLIST_COLORS[7] = new Color(255, 255, 255);
    ...
    /**
     * This method dequeues the pending song at the front of the queue and
     * updates the window to represent the current status
     *
     * @param button
    ...
    /**
     * Rejects adding the current song to the play list.
     *
     * @param button
     *            the reject button
     */
    ...
    /**
     * Draws a note at the given coordinates with the given color
     * 
     * @param x
     ...
     * updateNotes to redraw the remaining songs in the queue
     */
